...
const rows = [
    ...
    { id: 3, firstname: "Ichabod", lastname: "Crannis", email: "icrannis2@who.int" },
    ...
    { id: 7, firstname: "Briana", lastname: "Ramstead", email: "bramstead6@google.com.hk" },
    { id: 8, firstname: "Ibby", lastname: "Poynton", email: "ipoynton7@themeforest.net" },
    ...
    { id: 11, firstname: "Silvanus", lastname: "Maus", email: "smausa@usda.gov" },
    { id: 12, firstname: "Candide", lastname: "Ibbott", email: "cibbottb@google.com.au" },
    { id: 13, firstname: "Lida", lastname: "Langham", email: "llanghamc@phoca.cz" },
    { id: 14, firstname: "Stephine", lastname: "Bundey", email: "sbundeyd@wisc.edu" },
    ...
    { id: 22, firstname: "Kipp", lastname: "Tewelson", email: "ktewelsonl@unblog.fr" },
    ...
    { id: 27, firstname: "Aeriel", lastname: "Puddefoot", email: "apuddefootq@icio.us" },
    ...
    { id: 30, firstname: "Quentin", lastname: "Crickmore", email: "qcrickmoret@rambler.ru" },
