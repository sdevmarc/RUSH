...
const ShopInformation = () => {
    ...
    const [IsModalMunicipality, setIsModalMunicipality] = useState(false)
    const [IsModalBarangay, setIsModalBarangay] = useState(false)
    ...
    const handleModalMunicipality = () => {
        setIsModalMunicipality(true)
    }
    ...
    return (
        <>
            ...
            <View style={{ width: width, height: height, backgroundColor: '#323d48' }}>
                ...
                {
                    IsModalMunicipality === true && Platform.OS === 'ios' &&
                    (
                        <>
                            ...
                            <View
                                style={{ position: 'absolute', width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center', zIndex: 1 }}
                            >
                ...
                <ScrollView>
                    <View style={{ width: width, paddingHorizontal: width * 0.03, paddingVertical: height * 0.03 }}>
                        <View style={{ width: '100%', paddingTop: height * 0.1, gap: height * 0.01 }}>
                            ...
                            <TouchableOpacity
                                onPress={handleModalMunicipality}
