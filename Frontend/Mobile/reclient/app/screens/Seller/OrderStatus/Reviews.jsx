                        ...
                        <View style={{ width: '100%', paddingTop: height * 0.1, gap: height * 0.01 }}>
                            ...
                            <View style={{ width: '100%', backgroundColor: Colors.idleColor, borderRadius: height * 0.01 }}>
                                <View style={{ overflow: 'hidden', width: '100%', height: height * 0.27, padding: height * 0.01, justifyContent: 'space-between', alignItems: 'center' }}>
                                    ...
                                    <View style={{ width: '100%', height: '30%', paddingVertical: height * 0.01, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: height*0.01 }}>
                                        <View style={{ width: '47%', height: '100%', backgroundColor: Colors.semiblack, justifyContent: 'center', alignItems: 'center', borderRadius: height * 0.01 }}>
                                            <Text
