            ...
            <SafeAreaView style={{ flex: 1 }}>
                <ScrollView contentContainerStyle={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 1, justifyContent: 'space-between', marginVertical: height * 0.05 }}>
                        ...
                        <TouchableOpacity onPress={handleSuccessful} style={{ height: height * 0.06, borderRadius: height * 0.03, justifyContent: 'center', alignItems: 'center', backgroundColor: 'black', marginHorizontal: width * 0.1 }}>
