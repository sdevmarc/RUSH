...
export default function UserCompleted() {
    ...
    const fetchCancelled = async () => {
        try {
            ...
            const res = await axios.get(`${process.env.EXPO_PUBLIC_SERVER}/api/viewstatustransactions/${userId}/user/COMPLETED`)
  ...
  return (
    <>
            ...
            {isLoading && <Loading title={`Loading`} />}
                <Navbar title='Completed Orders' backgroundColor={Colors.backgroundColor} tintColor={Colors.fontColor} />
                <ScrollView>
